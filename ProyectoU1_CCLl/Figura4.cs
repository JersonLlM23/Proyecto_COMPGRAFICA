...
namespace ProyectoU1_CCLl
{
    ...
    /// </summary>
    public partial class Figura4 : Form
    {

        private static Figura4 instancia = null;


        public static Figura4 Instancia
        {
            get
            {
                if (instancia == null || instancia.IsDisposed)
                {
                    instancia = new Figura4();
                }
                return instancia;
            }
        }
        ...
        private void txtTamano_TextChanged_1(object sender, EventArgs e)
        {
