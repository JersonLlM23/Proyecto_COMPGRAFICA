            ...
            using (Pen pen = new Pen(Color.Black))
            {
                ...
                using (GraphicsPath clipPath_center_circle = new GraphicsPath())
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        double angle_start = 2 * Math.PI / 5 * i + angle_offset;
                        double angle_end = 2 * Math.PI / 5 * (i + 1) - angle_offset;
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        double angle_start = 2 * Math.PI / 5 * i;
                        double angle_end = 2 * Math.PI / 5 * (i + 1);
                        float radius_extra = radius * 1.1f;
                    ...
                    // CENTER CLIP PATH
                    clipPath_center_circle.AddEllipse(
                        new RectangleF(-center_circle_radius, -center_circle_radius,
